...
if __name__ == "__main__":
    ...
    default_pos = r"y2505,y,DCE,10,1,20,7944;rb2505,rb,SHFE,10,-1,3,3337;CF505,CF,CZCE,5,1,4,13850"
    ...
    mgr = CManagerViewer(positions=gen_positions(args.pos), config=config, desc="TEST for qviewer PNL")
    mgr.main()
