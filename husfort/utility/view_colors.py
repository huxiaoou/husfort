...
color = [
    ...
    ["Fuchsia", "灯笼海棠紫红色", "#FF00FF", (255, 0, 255)],
    ...
    ["Bisque", "(浓汤)乳脂番茄等", "#FFE4C4", (255, 228, 196)],
    ...
    ["LightSalmon", "浅鲜肉(鲑鱼色)", "#FFA07A", (255, 160, 122)],
...
table = Table(
    title="Transformation between RGB and HEX",
    title_style=f"bold {theme_color}",
    header_style=f"bold {theme_color}"
)

table.add_column(header="ENG", justify="right", style="green", no_wrap=True)
table.add_column(header="CHS", justify="left",  style="yellow")
...
for (color_eng, color_chs, color_hex, color_rgb) in color:
    color_font, color_background = color_hex, color_hex
    cell_sty = f"[{color_font} on {color_background}]"
    table.add_row(color_eng, color_chs, color_hex, str(color_rgb), f"{cell_sty}{'text':>32s}")
